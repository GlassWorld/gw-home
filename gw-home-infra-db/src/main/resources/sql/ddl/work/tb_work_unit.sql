CREATE TABLE IF NOT EXISTS tb_work_unit (
...
CREATE INDEX IF NOT EXISTS idx_work_unit_mbr_acct ON tb_work_unit (mbr_acct_idx);
CREATE INDEX IF NOT EXISTS idx_work_unit_listing ON tb_work_unit (mbr_acct_idx, use_yn, updated_at DESC, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_work_unit_last_used_at ON tb_work_unit (mbr_acct_idx, last_used_at DESC);
